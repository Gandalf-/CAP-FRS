...
//                ((EditText) findViewById(R.id.editVendorLocation)).getText(), ((EditText) findViewById(R.id.editServiceDate)).getText());
        ...
        canvas.drawText(String.format("FULL NAME: %s", fieldData.editName), leftMargin, titleBaseLine + 30, paint);
        canvas.drawText(String.format("CAP ID: %s", fieldData.editCAPID), leftMargin, titleBaseLine + 50, paint);
        canvas.drawText(String.format("AIRCRAFT TAIL #: %s\tMODEL:%s", fieldData.editAircraftTail, fieldData.editAircraftModel), leftMargin, titleBaseLine + 70, paint);
        canvas.drawText(String.format("MISSION DATE: %s",fieldData.editMissionDate), leftMargin, titleBaseLine + 90, paint);
        canvas.drawText(String.format("MISSION SYMBOL: %s", fieldData.editMissionSymbol), leftMargin, titleBaseLine + 110, paint);
        canvas.drawText(String.format("LIST ALL SORTIES INCLUDED: %s", fieldData.editSorties), leftMargin, titleBaseLine + 130, paint);
        canvas.drawText(String.format("TOTAL HOBBS TIME: %s", fieldData.editHobbsTime), leftMargin, titleBaseLine + 150, paint);
        canvas.drawText(String.format("TOTAL GALLONS FOR ALL SORTIES: %s", fieldData.editTotalGallons), leftMargin, titleBaseLine + 170, paint);
        canvas.drawText(String.format("TOTAL COST FOR ALL SORTIES: %s", fieldData.editFuelCost), leftMargin, titleBaseLine + 190, paint);
        canvas.drawText(String.format("AVG FUEL BURN: %.2f Gallons/Hour", fieldData.avgFuelBurn), leftMargin, titleBaseLine + 210, paint);
        canvas.drawText(String.format("REMARKS: %s",fieldData.editRemarks), leftMargin, titleBaseLine + 230, paint);
        canvas.drawText(String.format("Vendor Name: %s", fieldData.editVendorName), leftMargin, titleBaseLine + 250, paint);
        canvas.drawText(String.format("Vendor Location: %s", fieldData.editVendorLocation), leftMargin, titleBaseLine + 270, paint);
        canvas.drawText(String.format("DATE OF FUEL SERVICE: %s", fieldData.editServiceDate), leftMargin, titleBaseLine + 290, paint);
